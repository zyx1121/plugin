...
export const gmapsTools: ToolboxTool[] = [
  scriptTool({
    name: "gmaps_get_list",
    description:
      "Read a shared Google Maps place list: list name, owner, and every place with address, coordinates, note, and date added. Takes a share link — private (unshared) lists are not readable.",
    inputSchema: {
