...
Calendar, Mail, Reminders, Safari, screenshots, PDFs, OCR, PVE, E3, Uber Eats,
Google Maps lists, and other personal automation. The public interface is MCP.
The scripts under `scripts/` are implementation atoms, not a supported human
CLI surface.
...
```text
calendar e3p gmaps mail md2slide nycu ocr parttime pdf pve reminders safari screenshot timetable ubereats
```
